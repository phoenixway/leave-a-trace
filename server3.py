...
b = webdriver.Chrome(executable_path=r'/home/roman/.local/bin/chromedriver')
b.maximize_window()
...
d.get('https://public-api.wordpress.com/oauth2/authorize?client_id=78848&redirect_uri=http://localhost:3000/&response_type=token&blog=wayofphoenix')
